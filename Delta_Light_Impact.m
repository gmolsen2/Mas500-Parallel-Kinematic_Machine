...
JointCoordinatex_posE = zeros(n_i,n_j);
JointCoordinatex_posW = zeros(n_i,n_j);
JointCoordinatex_negE = zeros(n_i,n_j);
JointCoordinatex_negW = zeros(n_i,n_j);
...
for i=1:n_i
    ...
    for j=1:n_j
        ...
        while px < 90 && breaksignal == boolean(0)
            ...
            if ~isreal(pz)
                break
            elseif ~isreal(D2_x+E2_x+Angle_D+Angle_E)
                break
            ...
            if breaksignal == boolean(0)
                Resultsx_pos(i,j) = px;
                JointCoordinatex_posE(i,j) = JointCoordinate_E;
                JointCoordinatex_posW(i,j) = JointCoordinate_W;
            end
        ...
        while px > -90 && breaksignal == boolean(0)
            ...
            if breaksignal == boolean(0)
                Resultsx_neg(i,j) = -px;
                JointCoordinatex_negE(i,j) = JointCoordinate_E;
                JointCoordinatex_negW(i,j) = JointCoordinate_W;
            end
...
% figure(2)
% surf(AxesY,AxesZ,JointCoordinatex_posE)
% grid on
% colorbar
% xlabel('Y-axis [mm]')
% ylabel('Z-axis [mm]')
...
% 
% figure(3)
% surf(AxesY,AxesZ,JointCoordinatex_posW)
% grid on
% colorbar
% xlabel('Y-axis [mm]')
% ylabel('Z-axis [mm]')
...
% figure(5)
% surf(AxesY,AxesZ,JointCoordinatex_negE)
% grid on
% colorbar
% xlabel('Y-axis [mm]')
% ylabel('Z-axis [mm]')
...
% 
% figure(6)
% surf(AxesY,AxesZ,JointCoordinatex_negW)
% grid on
% colorbar
% xlabel('Y-axis [mm]')
% ylabel('Z-axis [mm]')
